sap.ui.define(['sap/ui/core/mvc/ControllerExtension',"sap/m/MessageBox"], function (ControllerExtension,MessageBox) {
	...
	return ControllerExtension.extend('com.airdit.agpp.accounts.account.ext.controller.UpdateAccountExt', {
		// this section allows to extend lifecycle hooks or hooks provided by Fiori elements
		override: {
			/**
             * Called when a controller is instantiated and its View controls (if available) are already created.
             * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
             * @memberOf com.airdit.agpp.accounts.account.ext.controller.UpdateAccountExt
             */
			onInit: function () {
